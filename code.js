...
figma.ui.onmessage = (msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (msg.type === "userPrompt") {
        ...
        try {
            const response = yield fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-04-17:generateContent?key=" +
                apiKey, {
                method: "POST",
                headers: {
      ...
      User Prompt: ${userPrompt}`,
            ...
            if (!response.ok) {
                ...
                figma.ui.postMessage({
                    type: "error",
                    message: `APIエラー: ${response.status} ${((_a = errorData.error) === null || _a === void 0 ? void 0 : _a.message) || ""}`,
                });
                return;
            }
